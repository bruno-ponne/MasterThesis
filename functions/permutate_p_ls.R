#-----------------------------------------------------------------------------------------#
# Function: permutate_p_ls()                                                              #
# Description: executes permutation test for primary and lower secondary school           #
#-----------------------------------------------------------------------------------------#

permutate_p_ls <- function(data){
  
  library(Synth)
  library(tidyverse)
  

  states <- c(11:17, 21:29, 31:33, 35, 41:43, 50:53)
